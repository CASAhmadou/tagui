...
casper.then(function() {{techo('type //*[@name="q"] as latest movies[enter]');
casper.waitFor(function check() {return check_tx('//*[@name="q"]');},
function then() {chrome.sendKeys(tx('//*[@name="q"]'),'latest movies',{keepFocus: true});
chrome.sendKeys(tx('//*[@name="q"]'),casper.page.event.key.Enter,{keepFocus: true});
chrome.sendKeys(tx('//*[@name="q"]'),'',{keepFocus: true});},
function timeout() {chrome.capture('/home/cas/TagUI_Linux/tagui/flows/samples/1_google_error.png');
this.echo('ERROR - cannot find //*[@name="q"]').exit(); this.wait(0);});}});
...
casper.then(function() {{techo('click (//*[@class="yuRUbf"])[1]//a');
casper.waitFor(function check() {return check_tx('(//*[@class="yuRUbf"])[1]//a');},
function then() {chrome.click(tx('(//*[@class="yuRUbf"])[1]//a'));},
function timeout() {chrome.capture('/home/cas/TagUI_Linux/tagui/flows/samples/1_google_error.png');
this.echo('ERROR - cannot find (//*[@class="yuRUbf"])[1]//a').exit(); this.wait(0);});}});
...
chrome.capture('/home/cas/TagUI_Linux/tagui/flows/samples/top_result.png');}});
